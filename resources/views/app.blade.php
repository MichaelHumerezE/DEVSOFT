...
<body>
                                ...
                                <div class="short_contact_list">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-envelope"></i>
                                                DEVSOFTPROJECT@gmail.com</a></li>
                                        <li><a href="#"> <i class="fa fa-phone"></i> +591 60933372</a></li>
                                    </ul>
                                </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-8">
                    <div class="info_text text-center">
                        ...
                        <a class="boxed-btn3" href="#">+591 60933372</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            <script>
                                ...
                                aria-hidden="true"></i> by <a href="{{ url('/') }}" target="_blank">DevSoft</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
    ...
    <script>
        var botmanWidget = {
            title: "DEVSOFT",
            aboutText: "DEVSOFT",
            introMessage: "Hola!, Bienvenido a DEVSOFT, ¿En que puedo ayudarte?",
